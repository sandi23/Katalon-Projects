...
<WebElementEntity>
   ...
   <name>html_Photo Printing  Jonas Pho_1</name>
   <tag></tag>
   <elementGuidId>a4879f1b-a510-4843-a6fe-9cbc4132bef9</elementGuidId>
...
#katalon{font-family:monospace;font-size:13px;background-color:rgba(0,0,0,.7);position:fixed;top:0;left:0;right:0;display:block;z-index:999999999;line-height: normal} #katalon div{padding:0;margin:0;color:#fff;} #katalon kbd{display:inline-block;padding:3px 5px;font:13px Consolas,&quot;Liberation Mono&quot;,Menlo,Courier,monospace;line-height:10px;color:#555;vertical-align:middle;background-color:#fcfcfc;border:1px solid #ccc;border-bottom-color:#bbb;border-radius:3px;box-shadow:inset 0 -1px 0 #bbb;font-weight: bold} div#katalon-elementInfoDiv {color: lightblue; padding: 5px}
              ...
              Photo Printing
                ...
                Photo Printing adalah lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla quis sodales purus, lobortis congue tortor. Ut scelerisque malesuada efficitur. Suspendisse facilisis eu nulla sed semper.
    ...
    $(document).on('click', '#btn-finish', function(e){
        ...
        $.ajax({
            ...
            dataType: &quot;JSON&quot;,
            data: {
                _token: &quot;rakHd160Tz88tOqXTKe7b5AIlfkMfEHpLQU3xkce&quot;,
                redirect: redirect,
            },
            success: function(response){
    ...
    $(document).on('click', '#checkout-tab-register-submit', function(e){
        ...
        $('.input-first-upload').change(function(){
            ...
            $('input.input-first-upload').attr('disabled', true);
            $('span.btn').attr('disabled', true);
            return false;
        });
