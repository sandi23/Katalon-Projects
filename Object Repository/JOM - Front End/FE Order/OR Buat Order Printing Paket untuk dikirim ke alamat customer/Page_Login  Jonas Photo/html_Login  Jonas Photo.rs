...
<WebElementEntity>
   ...
   <name>html_Login  Jonas Photo</name>
   <tag></tag>
   <elementGuidId>4d41c667-b99c-4773-8a73-a1046d6beada</elementGuidId>
   ...
   <webElementProperties>
    ...
    .uploaded-form-input .input-field.price{
        width : 16.6%;
    }
    
    .uploaded-form-input .input-field.remove{
        width : 3%;
    }

    .uploaded-form-input #product{
        margin-top: -15px;
        padding-left: 5px;
    }
    
    .uploaded-form-input #product h5{
        font-size: 22px;
        font-weight: 700;
    }
    
    .uploaded-form-input #product span{
        font-size: 18px;
        color: #777777;
    ...
    a.left.carousel-control.left.carousel-control.carousel-left-recomended {
        left: 30px;
    }

    a.right.carousel-control.carousel-right-recomended {
        right: 30px;
    }

    img.img-all-category {
        height: 100%;
        width: 100%;
    }

    .img-bg.white-bg.all-category {
        width: 100%;
        height: 150px;
    }
    ...
    .custom-label {
        font-size: 21px; font-weight: bold; height: 70px;
    }
...
#katalon{font-family:monospace;font-size:13px;background-color:rgba(0,0,0,.7);position:fixed;top:0;left:0;right:0;display:block;z-index:999999999;line-height: normal} #katalon div{padding:0;margin:0;color:#fff;} #katalon kbd{display:inline-block;padding:3px 5px;font:13px Consolas,&quot;Liberation Mono&quot;,Menlo,Courier,monospace;line-height:10px;color:#555;vertical-align:middle;background-color:#fcfcfc;border:1px solid #ccc;border-bottom-color:#bbb;border-radius:3px;box-shadow:inset 0 -1px 0 #bbb;font-weight: bold} div#katalon-elementInfoDiv {color: lightblue; padding: 5px}
              ...
              Login
                  ...
                  1
                    ...
                    * Estimasi waktu selesai yang tertera adalah berlaku jika Anda melakukan pembayaran pada hari ini. Keterlambatan pembayaran akan membuat keterlambatan waktu selesai.
  ...
  Log In
  Login dengan akun member Anda untuk mempermudah proses selanjutnya, dan dapatkan diskon khusus!
  ...
  Belum punya akun ?
  Daftar disini
  Dapatkan promosi menarik dan diskon khusus bagi member Jonas Photo
      ...
      Daftar
                                             ...
                                             Anda harus Log in atau Daftar untuk melanjutkan
    ...
    Produk yang Anda pilih: 1 produk
    
      Total Order: Rp 225.000
