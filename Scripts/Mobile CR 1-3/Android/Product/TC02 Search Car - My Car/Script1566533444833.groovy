...
'Mencari car by name'
Mobile.setText(findTestObject('Mobile/OR Order/android.widget.EditText0 - Search car'), 'daihatsu', 0)

Mobile.delay(findTestData('Delay Step').getValue(1, 2), FailureHandling.STOP_ON_FAILURE)

'Tap button search'
Mobile.tap(findTestObject('Mobile/OR Order/android.widget.ImageView6 - icon search'), 0)
