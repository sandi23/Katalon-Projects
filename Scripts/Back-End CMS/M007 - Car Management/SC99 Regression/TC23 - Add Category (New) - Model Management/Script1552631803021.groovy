...
WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Car Management/a_Add Category'))
...
WebUI.click(findTestObject('Backend/OR Car Management/Car Management/saveCategory'))
