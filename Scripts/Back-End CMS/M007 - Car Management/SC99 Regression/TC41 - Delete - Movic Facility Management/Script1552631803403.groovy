...
WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Facility Management/a_Lorem ipsum dolor sit amet_b_1'))

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Facility Management/button_Ok (1)'))
