...
WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Car Management/a_Add Brand'))
...
WebUI.click(findTestObject('Backend/OR Car Management/Car Management/saveBrand'))
