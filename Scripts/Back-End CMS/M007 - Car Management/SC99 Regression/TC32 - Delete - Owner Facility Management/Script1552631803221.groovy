...
WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Facility Management/a_Lepas Kunci_btn btn-danger b'))

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Facility Management/button_Ok'))
