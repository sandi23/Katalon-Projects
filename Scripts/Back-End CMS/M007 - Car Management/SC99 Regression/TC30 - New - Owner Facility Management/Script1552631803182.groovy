...
WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Facility Management/a_New'))
...
WebUI.rightClick(findTestObject('Object Repository/Backend/OR Car Management/Facility Management/input_Image _logo'))
