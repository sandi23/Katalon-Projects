...
WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Car Management/a_Jeep_btn btn-danger btn-sm a'))

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Car Management/button_Ok (1)'))
