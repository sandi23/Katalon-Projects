...
WebUI.selectOptionByValue(findTestObject('Object Repository/Backend/OR Car Management/Car Management/select_Brand (1)'), 
    'variant', true)

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.setText(findTestObject('Object Repository/Backend/OR Car Management/Car Management/input_New_searchValue (2)'), 'Model')

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Car Management/button_New_filterBtn (2)'))
