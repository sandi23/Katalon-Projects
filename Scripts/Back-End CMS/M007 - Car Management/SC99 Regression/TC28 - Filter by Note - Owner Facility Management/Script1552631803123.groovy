...
WebUI.selectOptionByValue(findTestObject('Object Repository/Backend/OR Car Management/Facility Management/select_Facility'), 
    'note', true)

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.setText(findTestObject('Object Repository/Backend/OR Car Management/Facility Management/input_New_searchValue'), 'car')

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Object Repository/Backend/OR Car Management/Facility Management/button_New_filterBtn'))
