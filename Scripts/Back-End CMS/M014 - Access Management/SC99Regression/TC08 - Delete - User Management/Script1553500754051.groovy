...
WebUI.click(findTestObject('Object Repository/Backend/OR Access Management/a_nansulaiman5updatemailinator'))

WebUI.click(findTestObject('Object Repository/Backend/OR Access Management/button_Ok'))
