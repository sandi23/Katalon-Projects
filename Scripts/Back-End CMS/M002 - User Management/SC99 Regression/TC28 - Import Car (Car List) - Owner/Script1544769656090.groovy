...
WebUI.click(findTestObject('Object Repository/Backend/OR User Management/Owner 2.0/a_Import'))

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Backend/OR User Management/Owner 2.0/btnImport'))

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Backend/OR User Management/Owner 2.0/btnFileTemplate'))

WebUI.delay(5)

WebUI.uploadFile(findTestObject('Backend/OR User Management/Owner 2.0/btnPilihFile'), 'C:\\Users\\Sandi\\Downloads\\car-template.csv')

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Backend/OR User Management/Owner 2.0/btnSaveImport'))
