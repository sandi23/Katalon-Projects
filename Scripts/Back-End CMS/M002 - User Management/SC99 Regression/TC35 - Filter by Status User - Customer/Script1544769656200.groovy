...
WebUI.selectOptionByValue(findTestObject('Object Repository/Backend/OR User Management/Owner 2.0/select_Name'), 'status-user', 
    true)

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.selectOptionByValue(findTestObject('Backend/OR User Management/Owner 2.0/statusUser'), 'ACTIVE', true)
