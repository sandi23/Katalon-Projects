...
WebUI.click(findTestObject('Backend/OR User Management/Owner 2.0/btnApproveCar'))

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Backend/OR User Management/Owner 2.0/modalApproveCarOK'))
