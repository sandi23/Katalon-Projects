...
WebUI.selectOptionByValue(findTestObject('Backend/OR User Management/Owner 2.0/fieldSearchFilter'), 'name', false)

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.setText(findTestObject('Object Repository/Backend/OR User Management/Owner 2.0/input_Car List_searchValue'), 'a')

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Object Repository/Backend/OR User Management/Owner 2.0/button_Car List_filterBtn'))
