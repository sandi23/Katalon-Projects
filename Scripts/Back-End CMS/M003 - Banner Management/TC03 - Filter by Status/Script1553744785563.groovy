...
WebUI.selectOptionByValue(findTestObject('Object Repository/Backend/OR User Management/Owner 2.0/select_Name'), 'status', 
    true)

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.selectOptionByValue(findTestObject('Object Repository/Backend/OR Web Management/Banner/select_Active'), 'active', 
    true)
