...
WebUI.click(findTestObject('Object Repository/Backend/OR City Management/a_garut_btn btn-danger btn-sm'))

WebUI.click(findTestObject('Object Repository/Backend/OR City Management/button_Ok'))
