...
WebUI.click(findTestObject('Object Repository/Backend/OR Web Management/FAQ/a_Topic'))

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/FAQ/input_Search_form-control inpu'), 'edited')

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Backend/OR Web Management/FAQ/btnDetail'))

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Backend/OR Web Management/FAQ/a_New'))

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/FAQ/input_Question _question'), 'question')
...
WebUI.click(findTestObject('Backend/OR Web Management/FAQ/btnSaveinDetail'))
