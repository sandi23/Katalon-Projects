...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/FAQ/input_Search_form-control inpu'), 'katalon topic')
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/FAQ/input_Topic _name'), 'edited topic')

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.selectOptionByValue(findTestObject('Object Repository/Backend/OR Web Management/FAQ/select_Select a type'), 'Vehicle Owner', 
    true)
