...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/FAQ/input_Search_form-control inpu'), 'Content katalon')

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Backend/OR Web Management/FAQ/btnEdit'))
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/FAQ/input_Cancel_select2-search__f'), 'kopi')
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/FAQ/input_Question _question'), 'Edited Content katalon')

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/FAQ/textarea_Answer_answer'), 'Edited answer')
