...
WebUI.selectOptionByValue(findTestObject('Page_Report - Finance/select_Transaction ID         '), 'rental', true)

WebUI.setText(findTestObject('Page_Report - Finance/input_Finance_searchValue'), '\tKira Car Rental Testing (Kaitokun kuroba)')
