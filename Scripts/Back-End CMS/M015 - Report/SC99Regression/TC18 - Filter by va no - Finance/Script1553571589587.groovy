...
WebUI.selectOptionByValue(findTestObject('Page_Report - Finance/select_Transaction ID         '), 'va-no', true)

WebUI.click(findTestObject('Page_Report - Finance/td_8620001538629591'))

WebUI.click(findTestObject('Page_Report - Finance/div_Transaction ID            '))

WebUI.setText(findTestObject('Page_Report - Finance/input_Finance_searchValue'), '8620001538629591')
