...
WebUI.selectOptionByValue(findTestObject('Page_Report - Finance/select_Transaction ID         '), 'period', true)

WebUI.click(findTestObject('Page_Report - Finance/td_26'))

WebUI.click(findTestObject('Page_Report - Finance/td_28'))

WebUI.click(findTestObject('Page_Report - Finance/button_Apply'))
