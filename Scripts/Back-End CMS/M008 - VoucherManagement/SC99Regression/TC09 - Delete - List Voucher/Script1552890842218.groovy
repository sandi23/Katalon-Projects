...
WebUI.click(findTestObject('Object Repository/Backend/OR Voucher/a_Available_btn btn-danger btn'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Backend/OR Voucher/button_Ok'))
