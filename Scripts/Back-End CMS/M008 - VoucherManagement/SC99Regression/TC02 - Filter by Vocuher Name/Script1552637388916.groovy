...
WebUI.setText(findTestObject('Object Repository/Backend/OR Voucher/input_New_searchValue'), 'voucher satu')

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Backend/OR Voucher/i_New_fa fa-filter'))
