...
WebUI.click(findTestObject('Page_Voucher Management/a_Go to list vouchers page'))

WebUI.delay(2)

WebUI.setText(findTestObject('Page_Voucher Management/input_New_searchValue'), 'a')

WebUI.click(findTestObject('Page_Voucher Management/i_New_fa fa-filter'))
