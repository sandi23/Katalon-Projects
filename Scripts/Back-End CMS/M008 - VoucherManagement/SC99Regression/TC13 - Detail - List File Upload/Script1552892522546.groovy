...
WebUI.click(findTestObject('Object Repository/Backend/OR Voucher/a_Go to list files page (1)'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Backend/OR Voucher/a_COMPLETED_btn btn-warning bt'))
