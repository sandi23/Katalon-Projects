...
WebUI.click(findTestObject('Page_Review Management/a_test review_btn btn-primary '))

WebUI.setText(findTestObject('Page_Review Management/input_Review _name'), 'test review update')
