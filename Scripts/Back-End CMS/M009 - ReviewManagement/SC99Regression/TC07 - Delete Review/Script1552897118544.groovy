...
WebUI.click(findTestObject('Object Repository/Backend/OR Review Management/a_review tambahan upda_btn btn'))

WebUI.click(findTestObject('Object Repository/Backend/OR Review Management/button_Ok'))
