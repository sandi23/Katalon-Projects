...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/Static Page/input_Title _title'), 'Katalon promo reserve')
...
WebUI.selectOptionByValue(findTestObject('Backend/OR Web Management/Static Page/iBeforeHour'), '23', true)

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.selectOptionByValue(findTestObject('Backend/OR Web Management/Static Page/iBeforeMinute'), '15', true)
