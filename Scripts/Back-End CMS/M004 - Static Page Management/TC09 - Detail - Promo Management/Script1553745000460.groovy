...
WebUI.setText(findTestObject('Object Repository/Backend/OR User Management/Owner/input_Search_form-control inpu'), 'testing katalon')

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Backend/OR Web Management/Static Page/btnDetail'))
