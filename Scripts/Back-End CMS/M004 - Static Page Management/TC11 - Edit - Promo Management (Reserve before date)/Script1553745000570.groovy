...
WebUI.setText(findTestObject('Object Repository/Backend/OR User Management/Owner/input_Search_form-control inpu'), 'Katalon promo reserve')
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/Static Page/input_Title _title'), 'Katalon promo reserve edited')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Backend/OR Web Management/Static Page/select_00'), '11', true)
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/Static Page/input_Promo Code _code'), 'KTR-002')
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/Static Page/input_Discount _discount'), '17')
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/Static Page/input_Quota_quota'), '18')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Backend/OR Web Management/Static Page/select_Minimum transaction'), 
    'Reserve before date', true)

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.click(findTestObject('Backend/OR Web Management/Static Page/pBeforeDate'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByValue(findTestObject('Backend/OR Web Management/Static Page/iBeforeHour'), '08', true)

WebUI.delay(findTestData('Delay Step').getValue(1, 1))

WebUI.selectOptionByValue(findTestObject('Backend/OR Web Management/Static Page/iBeforeMinute'), '55', true)
