...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/Static Page/input_Title _title'), 'Katalon promo car')
...
WebUI.selectOptionByLabel(findTestObject('Backend/OR Web Management/Static Page/dSyaratKategori'), 'Multi Purpose Vehicle', 
    true)
