...
WebUI.setText(findTestObject('Object Repository/Backend/OR User Management/Owner/input_Search_form-control inpu'), 'Katalon promo car')
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/Static Page/input_Title _title'), 'Katalon promo car edited')
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/Static Page/input_Promo Code _code'), 'KTC-003')
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/Static Page/input_Discount _discount'), '40')
...
WebUI.setText(findTestObject('Object Repository/Backend/OR Web Management/Static Page/input_Quota_quota'), '5')
...
WebUI.selectOptionByLabel(findTestObject('Backend/OR Web Management/Static Page/dSyaratBrand'), 'Peugeot', true)
