...
'Simulasi input password (bukan TC04)'
...
'Verifikasi muncul tabel statistik Peminjam'
WebUI.verifyElementVisible(findTestObject('Danamas - Front End/Dashboard Pemodal/OR Menampilkan detail pinjaman (detail)/Page_danamas/table_ID Peminjam'))

'Verifikasi muncul div Narasi Peminjam'
WebUI.verifyElementVisible(findTestObject('Danamas - Front End/Dashboard Pemodal/OR Menampilkan detail pinjaman (detail)/Page_danamas/p_Narasi Pinjaman'))
