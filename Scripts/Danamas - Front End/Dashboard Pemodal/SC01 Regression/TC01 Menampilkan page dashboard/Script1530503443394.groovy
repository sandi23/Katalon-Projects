...
'Simulasi klik gambar \'danamas\' (bukan TC01)'
...
'Verifikasi muncul tab Dashboard dengan text \'Dashboard\''
WebUI.verifyElementVisible(findTestObject('Danamas - Front End/Dashboard Pemodal/OR Menampilkan page dashboard/Page_danamas/h1_Dashboard'))

'Verifikasi muncul text penjelasan sebagai Lender'
WebUI.verifyElementVisible(findTestObject('Danamas - Front End/Dashboard Pemodal/OR Menampilkan page dashboard/Page_danamas/p_Selamat datang di Danamas'))
