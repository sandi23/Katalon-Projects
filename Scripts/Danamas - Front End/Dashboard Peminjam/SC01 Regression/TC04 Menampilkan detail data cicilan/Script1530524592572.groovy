...
'Simulasi buka browser, input URL, menunggu webpage loading (bukan TC04)'
...
'Verifikasi detail elemen pada kolom \'Cicilan\' bisa diklik'
WebUI.verifyElementClickable(findTestObject('Danamas - Front End/Dashboard Peminjam/OR Menampilkan data cicilan/Page_danamas/td_Lihat Cicilan'))
