...
WebUI.click(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/Tab Payment 2'))

WebUI.click(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/Payment Transaction 2'))

WebUI.delay(2)

WebUI.click(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/button_Customer - Copy'))

WebUI.setText(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/input_form-control input-sm'), 
    'Belinda')

WebUI.click(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/td_Riansyah Ramdani S. - Copy'))

WebUI.click(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/button_Order Process - Copy'))

Mobile.delay(20, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/button_Finish'))

WebUI.scrollToElement(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/img - Copy'), 
    0)

WebUI.click(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/img - Copy'))

WebUI.setText(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/input_pos1type11amount - Copy'), 
    '500000')

WebUI.scrollToPosition(0, 0)

WebUI.click(findTestObject('JOM - Front End/FE POS/OR Pembayaran Downpayment Order Reservasi/Page_JOM 3.0  Payment Transaction/a_Submit - Copy'))
