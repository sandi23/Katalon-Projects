...
WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat Order Studio non-reservasi/Page_Our Photo Studio Product  Jona/div_Studio Tempo Doeloe'))

WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat Order Studio non-reservasi/Page_Product catalogue  Jonas Photo/div_Pra Panganten'))
