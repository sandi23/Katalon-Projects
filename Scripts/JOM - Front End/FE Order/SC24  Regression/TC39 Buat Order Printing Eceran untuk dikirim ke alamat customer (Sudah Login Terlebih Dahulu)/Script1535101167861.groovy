...
WebUI.click(findTestObject('JOM - Front End/FE Order/OR Produk Printing With Frame/Page_Photo Printing  Jonas Photo/fieldset_form-group no-border'))
...
WebUI.doubleClick(findTestObject('JOM - Front End/FE Order/OR Produk Printing With Frame/Page_Photo Printing  Jonas Photo/label'))

WebUI.click(findTestObject('JOM - Front End/FE Order/OR Produk Printing With Frame/Page_Photo Printing  Jonas Photo/p_Frame 8R Klasik CHN-A5'))

WebUI.doubleClick(findTestObject('JOM - Front End/FE Order/OR Produk Printing With Frame/Page_Photo Printing  Jonas Photo/button_Simpan'))
...
WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Photo Printing  Jonas Photo/Button Kirim Bersamaan'))

WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Photo Printing  Jonas Photo/Link Lihat Foto 1st Produk'))

WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Photo Printing  Jonas Photo/Button Close'))
...
WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat Order Printing Paket untuk dikirim ke alamat customer/Page_Review Order  Jonas Photo/label_OKE  Rp 62.000'))
