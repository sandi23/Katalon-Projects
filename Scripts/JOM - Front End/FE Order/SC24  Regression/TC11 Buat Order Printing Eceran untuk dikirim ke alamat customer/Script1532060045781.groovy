...
'Simulasi mouse scroll ke div \'Regular Print\''
WebUI.scrollToElement(findTestObject('JOM - Front End/FE Order/OR Buat Order Printing Eceran untuk diambil di store/Page_Kategori Produk Printing  Jona/h4_Regular Print'), 
    1)
...
not_run: WebUI.uploadFile(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Photo Printing  Jonas Photo/input_images'), 
...
not_run: WebUI.setText(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Login  Jonas Photo/input_username'), 
    'beta@email.com')

not_run: WebUI.setText(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Login  Jonas Photo/input_password'), 
    'P@ssw0rd')

not_run: WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Login  Jonas Photo/button_Login'))
...
WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Review Order  Jonas Photo/button_Pilih_1'))
...
WebUI.verifyElementVisible(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Selesai  Jonas Photo/h2_Sudah Selesai. Terima Kasih'))
