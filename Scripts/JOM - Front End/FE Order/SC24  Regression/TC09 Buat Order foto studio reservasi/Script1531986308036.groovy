...
'Simulasi klik button \'Buat Order\''
WebUI.scrollToElement(findTestObject('JOM - Front End/FE Order/OR Buat Order Studio reservasi/Page_Buat Order  Jonas Photo/button_Buat Order'), 
    0)

'Simulasi klik button \'Buat Order\''
WebUI.doubleClick(findTestObject('JOM - Front End/FE Order/OR Buat Order Studio reservasi/Page_Buat Order  Jonas Photo/button_Buat Order'))

'Simulasi klik button \'Reservasi\''
WebUI.doubleClick(findTestObject('JOM - Front End/FE Order/OR Buat Order Studio reservasi/Page_Buat Order  Jonas Photo/button_Reservasi'))
...
'Simulasi klik button Login'
not_run: WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat Order Studio non-reservasi/Page_Produk Anda  Jonas Photo/button_Login'))
