...
WebUI.scrollToElement(findTestObject('JOM - Front End/FE Order/OR Buat Order Studio non-reservasi dengan kondisi Customer sudah login/Page_Helo you look great today   Jo/a_Pesan Photo'), 
    0)
