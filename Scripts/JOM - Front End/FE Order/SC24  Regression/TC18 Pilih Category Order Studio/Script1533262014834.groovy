...
WebUI.scrollToElement(findTestObject('JOM - Front End/FE Order/OR Buat Order non reservasi dengan penambahan pose, orang, dan frame/Page_Hello you look great today   J/a_Pesan Photo'), 
    3)
