...
WebUI.click(findTestObject('JOM - Front End/FE Studio Preview/OR Preview order Order Studio Non Reservasi untuk diambil di store/Page_Pengaturan  1 - Photo Studio M/a_Tidak Lewati'))
