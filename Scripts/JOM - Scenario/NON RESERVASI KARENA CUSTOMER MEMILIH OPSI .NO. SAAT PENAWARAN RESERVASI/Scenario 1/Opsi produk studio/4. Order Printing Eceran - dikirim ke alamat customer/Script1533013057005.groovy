...
WebUI.setText(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Login  Jonas Photo/input_username'), 
    'beta@email.com')

WebUI.setText(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Login  Jonas Photo/input_password'), 
    'P@ssw0rd')

WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat order printing eceran untuk dikirim ke alamat customer/Page_Login  Jonas Photo/button_Login'))
