...
not_run: for (def index : (1..3)) {
    not_run: WebUI.click(findTestObject('JOM - Scenario/NON RESERVASI KARENA CUSTOMER MEMILIH OPSI .NO. SAAT PENAWARAN RESERVASI/Scenario 4/Page_Produk Anda  Jonas Photo/span_glyphicon glyphicon-plus'))
}
...
not_run: WebUI.click(findTestObject('JOM - Front End/FE Order/OR Buat Order Studio reservasi/Page_Product catalogue  Jonas Photo/div_Platinum'))
...
WebUI.verifyElementVisible(findTestObject('JOM - Front End/FE Order/OR Buat Order Studio non-reservasi dengan kondisi Customer sudah login/Page_Produk Anda  Jonas Photo/h2_Sudah Selesai. Terima Kasih'))

'Verifikasi muncul notifikasi order berhasil'
WebUI.verifyElementVisible(findTestObject('JOM - Front End/FE Order/OR Buat Order Studio non-reservasi dengan kondisi Customer sudah login/Page_Produk Anda  Jonas Photo/p_Silahkan check-in di counter'))
