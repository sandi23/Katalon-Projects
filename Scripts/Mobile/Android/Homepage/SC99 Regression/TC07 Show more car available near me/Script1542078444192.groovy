...
'Show more car yang ada di near me'
Mobile.tap(findTestObject('Mobile/OR Homepage/android.widget.TextView11 - Show more'), 0)

'Select car'
Mobile.tap(findTestObject('Mobile/OR Homepage/android.widget.RelativeLayout2'), 0)
