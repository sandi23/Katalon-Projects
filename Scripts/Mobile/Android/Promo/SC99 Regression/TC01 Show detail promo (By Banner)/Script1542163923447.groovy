...
'Tap info & promo'
Mobile.tap(findTestObject('Mobile/OR Left Menu/android.widget.Left Menu - Info dan Promo'), 0)

'Tap tab promo'
Mobile.tap(findTestObject('Mobile/OR Promo/android.widget.Tab(1)'), 0)

'Select promo'
Mobile.tap(findTestObject('Mobile/OR Promo/android.widget.TextView4 - promo 25 februarypromo 25 february'), 0)
