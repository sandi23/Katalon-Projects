...
'Input email user'
Mobile.setText(findTestObject('Mobile/OR Login/android.widget.EditText0'), 'santi.wahyuni@wgs.co.id', 0)
...
'Submit form dan mengirim email link untuk step selanjutnya'
Mobile.tap(findTestObject('Mobile/OR Login/android.widget.Button0 - Next'), 0)
