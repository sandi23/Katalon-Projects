...
'Tap button continue with google'
Mobile.tap(findTestObject('Mobile/OR Registrasi/android.widget.LinearLayout3'), 0)

'Select account google'
Mobile.tap(findTestObject('Mobile/OR Registrasi/android.widget.LinearLayout8'), 0)

Mobile.tap(findTestObject('Mobile/OR Registrasi/TextInputLayout3 - Mobile Number'), 0)
...
WebUI.delay(findTestData('Delay Step').getValue(1, 2))
