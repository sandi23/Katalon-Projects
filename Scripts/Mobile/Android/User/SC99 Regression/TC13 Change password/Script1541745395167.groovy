...
Mobile.tap(findTestObject('Mobile/OR Profile/android.widget.TextView9 - Change Password'), 0)

Mobile.setText(findTestObject('Mobile/OR Profile/android.widget.EditText0 (1)'), 'P@ssword789', 0)

Mobile.tap(findTestObject('Mobile/OR Profile/android.widget.EditText1 (1)'), 0)

Mobile.setText(findTestObject('Mobile/OR Profile/android.widget.EditText1 (1)'), 'P@ssword987', 0)

Mobile.tap(findTestObject('Mobile/OR Profile/android.widget.EditText2'), 0)

Mobile.setText(findTestObject('Mobile/OR Profile/android.widget.EditText2'), 'P@ssword987', 0)
