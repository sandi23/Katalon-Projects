...
'Tap button create new account'
Mobile.tap(findTestObject('Mobile/OR Registrasi/android.widget.Button0 - Create New Account'), 0)

'Input first name'
Mobile.setText(findTestObject('Mobile/OR Registrasi/android.widget.EditText0'), 'Quality', 0)
...
'Tap kolom last name agar field dapat di input text'
Mobile.tap(findTestObject('Mobile/OR Registrasi/TextInputLayout1 - Last Name (Optional)'), 0)

'Input last name (optional)'
Mobile.setText(findTestObject('Mobile/OR Registrasi/android.widget.EditText1'), 'Assurance', 0)
...
'Tap button next'
Mobile.tap(findTestObject('Mobile/OR Registrasi/android.widget.Button0 - Next'), 0)

'Input email'
Mobile.setText(findTestObject('Mobile/OR Registrasi/android.widget.EditText0 (1)'), 'test.wgs01@gmail.com', 0)
...
'Tap button next'
Mobile.tap(findTestObject('Mobile/OR Registrasi/android.widget.Button0 - Next (2)'), 0)
