...
'Tap button forgot password?'
Mobile.tap(findTestObject('Mobile/OR Login/android.widget.TextView2 - Forgot Password'), 0)

'Input mobile number user'
Mobile.setText(findTestObject('Mobile/OR Login/android.widget.EditText0'), '082117284992', 0)

'Submit form dan mengirim verification code'
Mobile.tap(findTestObject('Mobile/OR Login/android.widget.Button0 - Next'), 0)

'Waiting untuk verification code'
Mobile.delay(findTestData('Delay Step').getValue(1, 3), FailureHandling.STOP_ON_FAILURE)

'Input new password user'
Mobile.setText(findTestObject('Mobile/OR Login/android.widget.EditText0 (1)'), 'P@ssword456', 0)

'Submit form dan konfirmasi success'
Mobile.tap(findTestObject('Mobile/OR Login/android.widget.Button0 - Next'), 0)

Mobile.tap(findTestObject('Mobile/OR Login/android.widget.TextView1 - Close'), 0)
