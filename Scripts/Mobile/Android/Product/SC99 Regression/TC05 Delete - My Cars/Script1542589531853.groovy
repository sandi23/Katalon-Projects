...
'Tap menu delete'
Mobile.tap(findTestObject('Mobile/OR Product/android.widget.RelativeLayout3 (1)'), 0)

'Select konfirmasi ok'
Mobile.tap(findTestObject('Mobile/OR Product/android.widget.TextView3 - OK'), 0)
