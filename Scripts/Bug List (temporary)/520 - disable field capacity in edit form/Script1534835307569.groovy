...
WebUI.setText(findTestObject('Bug List/519/Page_JOM 3.0  Dashboard/search'), 'user')

WebUI.delay(2)

WebUI.click(findTestObject('Bug List/519/Page_JOM 3.0  Employee/edit button'))

WebUI.delay(2)

WebUI.verifyElementNotClickable(findTestObject('Bug List/519/Page_JOM 3.0  Employee/capacity'))
