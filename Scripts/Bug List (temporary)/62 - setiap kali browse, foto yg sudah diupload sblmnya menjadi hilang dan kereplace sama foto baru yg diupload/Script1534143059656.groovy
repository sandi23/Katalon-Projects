...
WebUI.click(findTestObject('JOM - Back End/Store Management/a_Add New'))
...
TestObject img = findTestObject('JOM - Back End/Store Management/OR Order (SPV) - Product Merchandise - Delivery Store/Page_JOM 3.0  Add New Shipping Cost/img')

for (def index : (0..9)) {
    img.findProperty('xpath').setValue("id('preview-package')/img[$num]")

    WebUI.verifyElementVisible(img)
