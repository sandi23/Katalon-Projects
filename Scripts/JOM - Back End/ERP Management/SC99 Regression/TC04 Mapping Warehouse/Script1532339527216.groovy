...
WebUI.scrollToElement(findTestObject('JOM - Back End/ERP Management/Sync Warehouse/sync warehouse'), 3)

WebUI.click(findTestObject('JOM - Back End/ERP Management/Sync Warehouse/sync warehouse'))

WebUI.delay(3)

WebUI.click(findTestObject('JOM - Back End/ERP Management/Sync Warehouse/sync'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Page_JOM 3.0  Payment Type/div_Data has been successfully'), 3)

not_run: WebUI.setText(findTestObject('Object Repository/JOM - Back End/ERP Management/Sync Payment Tipe/input_form-control input-sm'), 
    'BCA')
