...
WebUI.scrollToElement(findTestObject('JOM - Back End/ERP Management/Sync Bank Code/span_Bank Code'), 3)

WebUI.click(findTestObject('JOM - Back End/ERP Management/Sync Bank Code/span_Bank Code'))

WebUI.delay(3)

WebUI.click(findTestObject('JOM - Back End/ERP Management/Sync Bank Code/a_Synchronize (1)'))
